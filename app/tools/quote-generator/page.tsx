...
export default function QuoteGeneratorPage() {
  ...
  const generatePDF = async () => {
    ...
    try {
      const response = await fetch('/api/tools/quote-pdf', {
        method: 'POST',
        ...
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Create professional quotes and estimates in seconds. Add your logo, line items, and download as PDF.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              {/* Recipient */}
              <div className="bg-gray-50 rounded-2xl p-6">
                <h2 className="text-lg font-semibold text-gray-900 mb-4">Quote For</h2>
                <div className="space-y-4">
                  <Input 
            ...
            <div className="lg:sticky lg:top-24 lg:self-start">
              <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
                <div className="mb-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Quote Preview</h3>
                  <p className="text-sm text-gray-500">This is how your quote will look</p>
                </div>
                ...
                <div className="bg-gray-50 rounded-xl p-6 text-sm">
                  ...
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <div className="text-right">
                      <h4 className="text-2xl font-bold text-gray-900">QUOTE</h4>
                      <p className="text-gray-500 text-xs mt-1">{quoteNumber}</p>
                    </div>
                  </div>
                  ...
                  <div className="mb-6 grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-xs text-gray-400 uppercase tracking-wider mb-1">Quote For</p>
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-gray-900">{quoteDate}</p>
                      {validUntil && (
                        <>
                          <p className="text-xs text-gray-400 uppercase tracking-wider mb-1 mt-2">Valid Until</p>
                          <p className="text-gray-900">{validUntil}</p>
                        </>
                      )}
                    </div>
                  </div>
          ...
          <div className="mt-20">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="font-semibold text-gray-900 mb-2">Is this quote generator really free?</h3>
                <p className="text-gray-600 text-sm">Yes, our quote generator is 100% free to use. No signup required, no hidden fees, no watermarks. Create unlimited professional quotes and estimates.</p>
              </div>
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="font-semibold text-gray-900 mb-2">Can I add my company logo to quotes?</h3>
                <p className="text-gray-600 text-sm">Yes, upload your company logo in PNG or JPG format. It will appear at the top of your quote for a professional branded appearance.</p>
              </div>
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="font-semibold text-gray-900 mb-2">What's the difference between a quote and an invoice?</h3>
                <p className="text-gray-600 text-sm">A quote is sent before work begins to show estimated costs. An invoice is sent after work is completed to request payment.</p>
              </div>
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="font-semibold text-gray-900 mb-2">Can I add multiple services or products?</h3>
                <p className="text-gray-600 text-sm">Yes, add as many line items as needed. Each item can have its own description, quantity, and rate with automatic total calculation.</p>
              </div>
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="font-semibold text-gray-900 mb-2">Can I set a validity period for my quote?</h3>
                <p className="text-gray-600 text-sm">Yes, use the "Valid Until" field to set an expiration date. This appears on the PDF so clients know how long the pricing is guaranteed.</p>
              </div>
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="font-semibold text-gray-900 mb-2">Is my data saved or stored?</h3>
                <p className="text-gray-600 text-sm">No, we don't store any of your quote data. The PDF is generated instantly and your information is never saved on our servers.</p>
              </div>
            </div>
          </div>
